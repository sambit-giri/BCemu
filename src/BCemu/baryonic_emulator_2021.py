...
path_to_emu0_file   = get_package_resource_path(package_name, 'input_data/kpls_emulator_z0_nComp3.pkl')
path_to_emu0p5_file = get_package_resource_path(package_name, 'input_data/kpls_emulator_z0p5_nComp3.pkl')
path_to_emu1_file   = get_package_resource_path(package_name, 'input_data/kpls_emulator_z1_nComp3.pkl')
path_to_emu1p5_file = get_package_resource_path(package_name, 'input_data/kpls_emulator_z1p5_nComp3.pkl')
path_to_emu2_file   = get_package_resource_path(package_name, 'input_data/kpls_emulator_z2_nComp3.pkl')
...
def check_trained_emulators():
	if not ( len(glob(path_to_emu0_file))*len(glob(path_to_emu0p5_file))*len(glob(path_to_emu1_file))*len(glob(path_to_emu1p5_file))*len(glob(path_to_emu2_file)) ):
		...
		download.download_emulators(model_name='BCemu2021')
