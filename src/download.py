...
print('at z = 0.5'); wget.download(link_to_emu0p5_file, path_to_emul_folder)
print('at z = 1.0'); wget.download(link_to_emu1_file,   path_to_emul_folder)
print('at z = 1.5'); wget.download(link_to_emu1p5_file, path_to_emul_folder)
print('at z = 2.0'); wget.download(link_to_emu2_file,   path_to_emul_folder)
