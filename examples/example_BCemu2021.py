...
ax1.set_ylabel(r'$\mathcal{S}(k)$')

ax2.set_title(r'$z=0.5$')
...
#ax3.set_legend()
ax3.set_xlabel(r'$k$ ($h$ Mpc$^{-1}$)')
ax3.set_ylabel(r'$\mathcal{S}(k)$')

ax4.set_title(r'$z=1.5$')
...
#ax4.legend()
ax4.set_xlabel(r'$k$ ($h$ Mpc$^{-1}$)')
ax4.set_ylabel(r'$\mathcal{S}(k)$')
...
#ax5.legend()
ax5.set_xlabel(r'$k$ ($h$ Mpc$^{-1}$)')
ax5.set_ylabel(r'$\mathcal{S}(k)$')
